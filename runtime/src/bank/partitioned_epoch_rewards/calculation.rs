...
impl Bank {
    ...
    fn calculate_stake_vote_rewards(
        ...
        let per_thread_stake_rewards = stake_delegations.len().div_ceil(num_threads);
        let per_thread_vote_accounts = estimated_num_vote_accounts.div_ceil(num_threads);
            ...
            measure_us!(thread_pool.install(|| {
                stake_delegations
                    ...
                    .fold(
                        || {
                            (
                                Vec::with_capacity(per_thread_stake_rewards),
                                HashMap::with_capacity_and_hasher(
                                    per_thread_vote_accounts,
                         ...
                         (stake_reward, (vote_pubkey, vote_reward))| {
                            ...
                            vote_rewards
                                ...
                                .or_insert(VoteReward {
                                    ...
                                    vote_account: vote_reward.vote_account,
                                    vote_rewards: 0,
                                })
                                .vote_rewards += vote_reward.vote_rewards;
                    ...
                    .reduce(
                        || {
                            (
                                Vec::with_capacity(stake_delegations.len()),
                                HashMap::with_capacity_and_hasher(
                        ...
                        |(mut stake_rewards_a, mut vote_rewards_a),
                         (stake_rewards_b, vote_rewards_b)| {
                            stake_rewards_a.extend(stake_rewards_b);
                            for (vote_pubkey, vote_reward) in vote_rewards_b {
                                vote_rewards_a
                                    .entry(vote_pubkey)
                                    .or_insert(VoteReward {
                                        commission: vote_reward.commission,
                            ...
                            (stake_rewards_a, vote_rewards_a)
                        },
                    )
            }));
