use {
    crate::packet::TpuPacketBatch,
    rand::{thread_rng, Rng},
};

pub fn discard_batches_randomly(
    batches: &mut Vec<TpuPacketBatch>,
    max_packets: usize,
...
#[cfg(test)]
mod tests {
    use {super::*, crate::packet::TpuPacket};

    #[test]
    fn test_batch_discard_random() {
        solana_logger::setup();
        let mut batch = TpuPacketBatch::default();
        batch.resize(1, TpuPacket::default());
        let num_batches = 100;
