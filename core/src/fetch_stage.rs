...
use {
    ...
    solana_perf::{
        packet::{PacketBatchRecycler, PacketBatchType, TpuPacket},
        recycler::Recycler,
    },
...
impl FetchStage {
    ...
    pub fn new_with_sender(
        ...
        tpu_vote_sockets: Vec<UdpSocket>,
        exit: Arc<AtomicBool>,
        sender: &Sender<PacketBatchType>,
        vote_sender: &Sender<PacketBatchType>,
        forward_sender: &Sender<PacketBatchType>,
        forward_receiver: Receiver<PacketBatchType>,
        poh_recorder: &Arc<RwLock<PohRecorder>>,
        coalesce: Duration,
